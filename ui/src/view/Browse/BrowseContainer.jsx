...
import {
  fetchBrowsedNeosThunk,
  fetchBrowsedNeosReverseThunk,
} from "../../state/thunks";
...
class BrowseContainer extends Component {
  ...
  handleScroll = (event) => {
    ...
    if (element.scrollHeight - element.scrollTop === element.clientHeight) {
      if (this.props.bottomPage.number === this.props.page.total_pages)
        this.props.fetchBrowsedNeos(0);
    ...
    // Scrolling to top
      ...
      if (
        this.props.page.number === 0 ||
        this.props.topPage.number === undefined
      )
        this.props.fetchBrowsedNeosReverse(this.props.page.total_pages - 1);
...
function mapDispatch(dispatch) {
  return {
    ...
    fetchBrowsedNeosReverse: (page) =>
      dispatch(fetchBrowsedNeosReverseThunk(page)),
  };
}

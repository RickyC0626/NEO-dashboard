      ...
      {od ? (
        <div className="content">
          <ul>
            ...
            <li>
              <div className="col-1-of-2 left">
                <strong>Data Arc in Days: </strong>
              </div>
            ...
            <li>
              <div className="col-1-of-2 left">
                <strong>
                  <a
                    href="https://en.wikipedia.org/wiki/Uncertainty_parameter"
                    target="_blank"
            ...
            <li>
              <div className="col-1-of-2 left">
                <strong>
                  <a
                    href="https://en.wikipedia.org/wiki/Minimum_orbit_intersection_distance"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
              ...
              <div className="col-1-of-2 right">
                {parseFloat(minOrbitIntersect).toLocaleString()}
              </div>
            </li>
            <li>
              <div className="col-1-of-2 left">
                <strong>
                  <a
                    href="https://en.wikipedia.org/wiki/Tisserand%27s_parameter"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
              ...
              <div className="col-1-of-2 right">
                {parseFloat(jupiterTissInvar).toLocaleString()}
              </div>
            </li>
            <li>
              <div className="col-1-of-2 left">
                <strong>
                  <a
                    href="https://en.wikipedia.org/wiki/Osculating_orbit"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Epoch Osculation
              ...
              <div className="col-1-of-2 right">
                {parseFloat(epochOsc).toLocaleString()}
              </div>
            </li>
            <li>
              <div className="col-1-of-2 left">
              ...
              <div className="col-1-of-2 right">
                {parseFloat(eccentricity).toLocaleString()}
              </div>
            </li>
            <li>
              <div className="col-1-of-2 left">
                <strong>
                  <a
                    href="https://en.wikipedia.org/wiki/Semi-major_and_semi-minor_axes#Astronomy"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Semi Major Axis
              ...
              <div className="col-1-of-2 right">
                {parseFloat(semiMajorAxis).toLocaleString()}
              </div>
            </li>
            <li>
              <div className="col-1-of-2 left">
              ...
              <div className="col-1-of-2 right">
                {parseFloat(inclination).toLocaleString()}
              </div>
            </li>
            <li>
              <div className="col-1-of-2 left">
                <strong>
                  <a
                    href="https://en.wikipedia.org/wiki/Orbital_node"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
              ...
              <div className="col-1-of-2 right">
                {parseFloat(ascNodeLong).toLocaleString()}
              </div>
            </li>
            <li>
              <div className="col-1-of-2 left">
              ...
              <div className="col-1-of-2 right">
                {parseFloat(orbitPeriod).toLocaleString()}
              </div>
            </li>
            <li>
              <div className="col-1-of-2 left">
              ...
              <div className="col-1-of-2 right">
                {parseFloat(periDist).toLocaleString()}
              </div>
            </li>
            <li>
              <div className="col-1-of-2 left">
              ...
              <div className="col-1-of-2 right">
                {parseFloat(periArg).toLocaleString()}
              </div>
            </li>
            <li>
              <div className="col-1-of-2 left">
              ...
              <div className="col-1-of-2 right">
                {parseFloat(apDist).toLocaleString()}
              </div>
            </li>
            <li>
              <div className="col-1-of-2 left">
                <strong>
                  <a
                    href="https://en.wikipedia.org/wiki/Apsis#Time_of_perihelion"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Perihelion Time
              ...
              <div className="col-1-of-2 right">
                {parseFloat(periTime).toLocaleString()}
              </div>
            </li>
            <li>
              <div className="col-1-of-2 left">
              ...
              <div className="col-1-of-2 right">
                {parseFloat(meanAnomaly).toLocaleString()}
              </div>
            </li>
            <li>
              <div className="col-1-of-2 left">
              ...
              <div className="col-1-of-2 right">
                {parseFloat(meanMotion).toLocaleString()}
              </div>
            </li>
            <li>
              <div className="col-1-of-2 left">
                <strong>
                  <a
                    href="https://en.wikipedia.org/wiki/Equinox_(celestial_coordinates)"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Equinox
            ...
            <li>
              <div className="col-1-of-2 left">
                <strong>
                  <a
                    href="https://pdssbn.astro.umd.edu/data_other/objclass.shtml"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Orbit Class Type
